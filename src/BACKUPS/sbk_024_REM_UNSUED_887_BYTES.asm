...
;; -- was already taken
;; remove unused functions         - 887 bytes exe
...
THREAD_BYTES_READ     equ -16        ; worker local bytes-read storage
THREAD_FILE_BUF       equ -(FILEBUF_SIZE + 16) ; worker local file buffer
